defmodule DistributedLogV3.PromEx do
  @moduledoc """
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :distributed_log_v3, DistributedLogV3.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule DistributedLogV3Web.Endpoint do
       use Phoenix.Endpoint, otp_app: :distributed_log_v3

       ...

       plug PromEx.Plug, prom_ex_module: DistributedLogV3.PromEx
  ...
  use PromEx, otp_app: :distributed_log_v3
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: DistributedLogV3Web.Router, endpoint: DistributedLogV3Web.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # DistributedLogV3.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      {:prom_ex, "beam.json"},
      {Plugins.Phoenix, router: MyAppWeb.Router, endpoint: MyAppWeb.Endpoint},
      DistributedLogV3.PromExPlugin
      ...
      # {:distributed_log_v3, "/grafana_dashboards/user_metrics.json"}
